      ...
      >
        <SwiperSlide className="swiper-slide">
          <div className="banner-lookbook">
            <Image
              className="lazyload"
              data-src="/images/banner/banner-lb-Women1.jpg"
              alt="banner"
              src="/images/banner/banner-lb-Women1.jpg"
              width={1920}
              height={600}
            />
        ...
        <SwiperSlide className="swiper-slide">
          <div className="banner-lookbook">
            <Image
              className="lazyload"
              data-src="/images/banner/banner-lb-Women2.jpg"
              alt="banner"
              src="/images/banner/banner-lb-Women2.jpg"
              width={1920}
              height={600}
            />
            <div className="lookbook-item position3">
